...
export default function CanvasExample() {
  ...
  return (
    <div className="w-screen relative h-[150vh] flex flex-col p-2 pr-10 pt-10 bg-gray-500 overflow-hidden">
      <div className="flex justify-start items-start flex-none">
        <div className="w-full h-full flex flex-col mt-[-20] px-4 pb-4">
